...
1. `.claude/skills/powershell-development/ui/templates.md` - Template de script
2. `.claude/skills/powershell-development/naming.md` - Conventions de nommage
3. `.claude/skills/powershell-development/logging.md` - Configuration du logging
4. `.claude/skills/powershell-development/ui/symbols.md` - Brackets de status
