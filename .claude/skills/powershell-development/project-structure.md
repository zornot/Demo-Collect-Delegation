...
|----------|---------|-------------|
| `/create-script MonScript` | create-script.md | Cree un script complet |
| `/create-function Get-User` | create-function.md | Cree une fonction Verb-Noun |
| `/create-issue BUG-001` | create-issue.md | Cree une issue locale |
