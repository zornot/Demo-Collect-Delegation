...
Les Skills `.claude/skills/` remplacent le traditionnel `CONTRIBUTING.md` :

| Ancien modele | Nouveau modele |
|---------------|----------------|
| `CONTRIBUTING.md` (pour humains) | `.claude/skills/*/SKILL.md` (pour AI) |
| Guide verbeux, explicatif | Regles concises, declaratives |
| Difficile a maintenir | Modulaire par domaine |

Les skills sont actives automatiquement par Claude selon leur description.
