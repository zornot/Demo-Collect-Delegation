...
1. `.claude/rules/powershell/pester.md` - Structure des tests, Mocks
2. `.claude/rules/common/testing-data.md` - Donnees anonymes
3. `.claude/rules/common/tdd.md` - Cycle TDD
