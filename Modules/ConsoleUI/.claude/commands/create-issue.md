...
Creer un fichier issue dans `audit/issues/$ARGUMENTS.md` en utilisant le template du projet.

## Reference

Lire `.claude/rules/common/workflow.md` pour le template complet des issues.
...
| Commit Resolution | (hash du commit) |
```
...
BUG, FEAT, REFACTOR, ARCH, DRY, PERF
