...
- `/project:run-tests` - Executer tous les tests
- `/project:run-tests Unit` - Executer uniquement les tests unitaires
- `/project:run-tests Integration` - Executer les tests d'integration
...
3. Suggerer des corrections basees sur `.claude/rules/powershell/errors.md`
