...
1. `.claude/rules/common/audit-methodology.md` - Structure 6 phases
2. `.claude/rules/common/anti-false-positives.md` - Protocole validation
3. `.claude/rules/common/metrics-sqale.md` - Quantification metriques

Puis lire les regles specifiques :
- `.claude/rules/powershell/security.md` - OWASP, Trust Boundaries
- `.claude/rules/powershell/performance.md` - Big O, parallelisation
- `.claude/rules/powershell/patterns.md` - SOLID, anti-patterns architecture
