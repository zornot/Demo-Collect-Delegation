...
- `.claude/rules/powershell/security.md` - Patterns securite (TryParse, Test-SafePath, credentials)
- `.claude/rules/RULES.md` - Standards generaux du projet
...
Pour un audit securite complet, consulter `.claude/rules/powershell/security.md` section OWASP :
...
Reference complete : `.claude/rules/common/anti-false-positives.md`
...
- `.claude/rules/common/audit-methodology.md` - Structure phases
- `.claude/rules/common/anti-false-positives.md` - Protocole validation
- `.claude/rules/common/metrics-sqale.md` - Quantification dette
- `.claude/rules/powershell/security.md` - OWASP + Trust Boundaries complet
