...
Avant d'ecrire des tests, lire les conventions :
- `.claude/rules/RULES.md` - Standards principaux
- `.claude/rules/powershell/pester.md` - Structure tests, BeforeAll, Mock, TestCases
- `.claude/rules/common/testing-data.md` - Donnees de test anonymes
- `.claude/rules/common/tdd.md` - Workflow TDD
